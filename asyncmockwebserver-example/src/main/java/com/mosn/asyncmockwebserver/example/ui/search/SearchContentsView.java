...
public class SearchContentsView extends FrameLayout {
  ...
  @Bind(R.id.search_contents_toolbar)
  protected Toolbar toolbar;

  @Bind(R.id.search_contents_listview)
  protected ListView contentsListView;

  @Bind(R.id.search_contents_progress)
  protected ProgressWheel progressWheel;

  @Bind(R.id.search_contents_search_status_textview)
  protected TextView searchStatusTextView;
